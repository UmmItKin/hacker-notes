...
Curl is a command-line tool for transferring data with URLs. moreover we can create a request to a server using curl.
...
## Reset password with username and email (Vulnerable)
